...
<?php
    if (is_page('276'))
	{
	 echo '<link href="/wordpress/dsajdl01/wp-content/themes/graphene-child/HotDC.css?ver=3.5.1" rel="stylesheet" type="text/css" />';
	}
	else if(is_page('312'))
	{
	echo '<link href="/wordpress/dsajdl01/wp-content/themes/graphene-child/HotDC.css?ver=3.5.1" rel="stylesheet" type="text/css" />';
...
<div id="container" class="container_16">
    ...
    <div id="header">
        ...
        <?php 
			if (is_page('276'))
			{
				echo "<img src='/wordpress/dsajdl01/wp-content/uploads/2013/02/LogoHotDC_BlackIII.jpg' alt='HOT_DC logo'/>";
			}
			else if (is_page('317'))
			{
				echo "<img src='/wordpress/dsajdl01/wp-content/uploads/2013/02/LogoHotDC_BlackIII.jpg' alt='HOT_DC logo'/>";
