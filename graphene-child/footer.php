...
<?php endif; ?>
    ...
    <?php endif; ?>
		<div class="icon_social_media">					
			<a title="Link to FaceBook of Hot DC Street Dance" href="https://www.facebook.com/henleyonthamesdancecrew">
					<img src="/wordpress/dsajdl01/wp-content/uploads/2013/02/fbIconIII.jpg" alt="facebook Icon" />
			</a>
			<a title="Link to Twitter" href="#">
			 	<img class="witter" src="/wordpress/dsajdl01/wp-content/uploads/2013/02/TWicon.jpg" alt="twitter Icon"/> 
			</a>
		</div>
